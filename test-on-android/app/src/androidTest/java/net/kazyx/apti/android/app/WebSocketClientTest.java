...
import net.kazyx.apti.AptiLog;
import net.kazyx.apti.Base64;
import net.kazyx.apti.CloseStatusCode;
import net.kazyx.apti.HttpHeader;
import net.kazyx.apti.WebSocket;
import net.kazyx.apti.WebSocketClientFactory;
...
public class WebSocketClientTest extends ApplicationTestCase<Application> {
